(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('apollo-client'), require('prop-types'), require('react'), require('react-dom/server')) :
    typeof define === 'function' && define.amd ? define(['exports', 'apollo-client', 'prop-types', 'react', 'react-dom/server'], factory) :
    (factory((global['react-apollo'] = {}),global.apolloClient,global.PropTypes,global.React,global.ReactDOM));
}(this, (function (exports,apolloClient,PropTypes,React,ReactDOM) { 'use strict';
    ...
    function getMarkupFromTree(_a) {
        var tree = _a.tree, _b = _a.context, context = _b === void 0 ? {} : _b, _c = _a.renderFunction, renderFunction = _c === void 0 ? ReactDOM.renderToStaticMarkup : _c;
